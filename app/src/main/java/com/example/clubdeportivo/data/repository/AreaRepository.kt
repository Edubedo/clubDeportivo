...
interface AreaRepository {
    ...
    suspend fun obtenerAreaPorId(id: Int): Area?
}

/**
 * Datos de prueba: cuando exista la API, se cambia por RetrofitClient.apiService.obtenerAreas().
 *
...
class FakeAreaRepository : AreaRepository {
    ...
    override suspend fun obtenerAreaPorId(id: Int): Area? {
        delay(200)
